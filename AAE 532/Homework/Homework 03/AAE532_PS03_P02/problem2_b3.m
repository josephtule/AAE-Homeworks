...
GMAT sat.SMA = 27500;
GMAT sat.ECC = 0.5999999999999998;
GMAT sat.INC = 0;
GMAT sat.RAAN = 0;
...
GMAT sat3.SMA = 79999.99999999997;
GMAT sat3.ECC = 0.6000000000000002;
GMAT sat3.INC = 0;
GMAT sat3.RAAN = 0;
...
GMAT DefaultOrbitView.RelativeZOrder = 182;
...
GMAT DefaultGroundTrackPlot.UpperLeft = [ 0 0.4482352941176471 ];
GMAT DefaultGroundTrackPlot.Size = [ 0.5 0.4505882352941176 ];
GMAT DefaultGroundTrackPlot.RelativeZOrder = 184;
...
GMAT ReportFile1.Filename = 'C:\Users\Joseph\Desktop\GMAT\AAE532\AAE532_PS03_P02\problem2_b3.txt';
