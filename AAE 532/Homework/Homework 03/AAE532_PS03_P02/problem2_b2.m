...
GMAT sat.SMA = 59999.99999999999;
GMAT sat.ECC = 0.2000000000000001;
GMAT sat.INC = 45;
GMAT sat.RAAN = 0;
...
GMAT sat2.SMA = 60000;
GMAT sat2.ECC = 0.5;
GMAT sat2.INC = 45.00000000000001;
GMAT sat2.RAAN = 0;
...
GMAT sat3.SMA = 59999.99999999996;
GMAT sat3.ECC = 0.85;
GMAT sat3.INC = 45;
GMAT sat3.RAAN = 0;
GMAT sat3.AOP = 151.8167000000001;
GMAT sat3.TA = 179.9999991462263;
...
GMAT DefaultOrbitView.RelativeZOrder = 129;
...
GMAT DefaultGroundTrackPlot.UpperLeft = [ 0 0.4494117647058823 ];
GMAT DefaultGroundTrackPlot.Size = [ 0.5 0.4505882352941176 ];
GMAT DefaultGroundTrackPlot.RelativeZOrder = 123;
...
GMAT ReportFile1.Filename = 'C:\Users\Joseph\Desktop\GMAT\AAE532\AAE532_PS03_P02\problem2_b2.txt';
